...
import { createUserPresence } from "../graphql/mutations";
const client = generateClient();
export default function UserPresenceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUserPresence.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserPresenceCreateForm")}
      {...rest}
    >
      <TextField
        label="Email"
